...
/* 58 */       String str = String.valueOf(String.valueOf(configFolder)); throw new IllegalStateException(61 + str.length() + str + " already exists as a file, but is " + "expected to be a directory.");
/*    */     }
/*    */ 
/* 62 */     return new File(configFolder, filename);
/*    */   }
/*    */ 
/*    */   public static InputStream openAssetConfigFile(AssetManager assetManager, String filename)
/*    */     throws IOException
/*    */   {
/* 75 */     String assetPath = new File("Cardboard", filename).getPath();
/* 76 */     return assetManager.open(assetPath);
/*    */   }
/*    */ }
