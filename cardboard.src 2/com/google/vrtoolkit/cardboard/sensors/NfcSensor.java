...
/*   106 */     this.context = context.getApplicationContext();
/*   107 */     this.nfcAdapter = NfcAdapter.getDefaultAdapter(this.context);
/*   108 */     this.listeners = new ArrayList();
/*   109 */     this.tagLock = new Object();
/*       */ 
/*   112 */     if (this.nfcAdapter == null) {
/*   113 */       return;
/*       */     }
/*       */ 
...
/*   120 */     this.nfcIntentFilters = new IntentFilter[] { ndefIntentFilter };
/*       */ 
/*   123 */     this.context.registerReceiver(new BroadcastReceiver()
/*       */     {
...
/*       */     }
/*       */ 
/*   143 */     synchronized (this.listeners) {
/*   144 */       for (ListenerHelper helper : this.listeners) {
/*   145 */         if (helper.getListener() == listener) {
/*   146 */           return;
/*       */         }
/*       */       }
/*       */ 
/*   150 */       this.listeners.add(new ListenerHelper(listener, new Handler()));
/*       */     }
/*       */   }
/*       */ 
...
/*   165 */       for (ListenerHelper helper : this.listeners)
/*   166 */         if (helper.getListener() == listener) {
/*   167 */           this.listeners.remove(helper);
/*   168 */           return;
/*       */         }
/*       */     }
/*       */   }
...
/*       */   {
/*   180 */     return this.nfcAdapter != null;
/*       */   }
/*       */ 
/*       */   public boolean isNfcEnabled()
/*       */   {
/*   189 */     return (isNfcSupported()) && (this.nfcAdapter.isEnabled());
/*       */   }
/*       */ 
/*       */   public boolean isDeviceInCardboard()
/*       */   {
/*   199 */     synchronized (this.tagLock) {
/*   200 */       return this.currentTagIsCardboard;
/*       */     }
/*       */   }
/*       */ 
/*       */   public NdefMessage getTagContents()
/*       */   {
/*   210 */     synchronized (this.tagLock) {
/*   211 */       return this.currentNdef != null ? this.currentNdef.getCachedNdefMessage() : null;
/*       */     }
/*       */   }
/*       */ 
...
/*       */   {
/*   225 */     synchronized (this.tagLock) {
/*   226 */       return this.currentNdef != null ? this.currentNdef.getNdefMessage() : null;
/*       */     }
/*       */   }
/*       */ 
/*       */   public int getTagCapacity()
/*       */   {
/*   237 */     synchronized (this.tagLock) {
/*   238 */       if (this.currentNdef == null) {
/*   239 */         throw new IllegalStateException("No NFC tag");
/*       */       }
/*       */ 
/*   242 */       return this.currentNdef.getMaxSize(); }  } 
/*       */   // ERROR //
/*       */   public void writeUri(Uri uri) throws TagLostException, IOException, java.lang.IllegalArgumentException { // Byte code:
/*       */     //   0: aload_0
/*       */     //   1: getfield 9	com/google/vrtoolkit/cardboard/sensors/NfcSensor:tagLock	Ljava/lang/Object;
/*       */     //   4: dup
/*       */     //   5: astore_2
/*       */     //   6: monitorenter
/*       */     //   7: aload_0
/*       */     //   8: getfield 51	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTag	Landroid/nfc/Tag;
/*       */     //   11: ifnonnull +13 -> 24
...
/*       */     //   182: astore 4
/*       */     //   184: aload_0
/*       */     //   185: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   188: ifnull +150 -> 338
/*       */     //   191: aload_0
/*       */     //   192: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   195: invokevirtual 66	android/nfc/tech/Ndef:isConnected	()Z
/*       */     //   198: ifne +10 -> 208
/*       */     //   201: aload_0
/*       */     //   202: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   205: invokevirtual 67	android/nfc/tech/Ndef:connect	()V
/*       */     //   208: aload_0
/*       */     //   209: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
...
/*       */     //   226: dup
/*       */     //   227: aload_0
/*       */     //   228: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
...
/*       */     //   283: athrow
/*       */     //   284: aload_0
/*       */     //   285: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   288: aload 4
...
/*       */     //   337: athrow
/*       */     //   338: aload_0
/*       */     //   339: getfield 51	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTag	Landroid/nfc/Tag;
...
/*       */     //   432: aload_0
/*       */     //   433: aload_0
/*       */     //   434: getfield 51	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTag	Landroid/nfc/Tag;
...
/*       */ 
/*   359 */     PendingIntent pendingIntent = PendingIntent.getBroadcast(this.context, 0, intent, 0);
/*   360 */     this.nfcAdapter.enableForegroundDispatch(activity, pendingIntent, this.nfcIntentFilters, (String[][])null);
/*       */   }
/*       */ 
...
/*       */     }
/*       */ 
/*   373 */     this.nfcAdapter.disableForegroundDispatch(activity);
/*       */   }
/*       */ 
/*       */   public void onNfcIntent(Intent intent)
/*       */   {
/*   382 */     if ((!isNfcEnabled()) || (intent == null) || (!this.nfcIntentFilters[0].matchAction(intent.getAction()))) {
/*   383 */       return;
/*       */     }
/*       */ 
/*   386 */     onNewNfcTag((Tag)intent.getParcelableExtra("android.nfc.extra.TAG")); } 
/*       */   // ERROR //
...
/*       */     //   4: return
/*       */     //   5: aload_0
/*       */     //   6: getfield 9	com/google/vrtoolkit/cardboard/sensors/NfcSensor:tagLock	Ljava/lang/Object;
/*       */     //   9: dup
/*       */     //   10: astore_2
/*       */     //   11: monitorenter
/*       */     //   12: aload_0
/*       */     //   13: getfield 51	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTag	Landroid/nfc/Tag;
/*       */     //   16: astore_3
/*       */     //   17: aload_0
/*       */     //   18: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   21: astore 4
/*       */     //   23: aload_0
/*       */     //   24: getfield 44	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTagIsCardboard	Z
/*       */     //   27: istore 5
/*       */     //   29: aload_0
/*       */     //   30: invokespecial 6	com/google/vrtoolkit/cardboard/sensors/NfcSensor:closeCurrentNfcTag	()V
/*       */     //   33: aload_0
/*       */     //   34: aload_1
/*       */     //   35: putfield 51	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTag	Landroid/nfc/Tag;
/*       */     //   38: aload_0
/*       */     //   39: aload_1
/*       */     //   40: invokestatic 115	android/nfc/tech/Ndef:get	(Landroid/nfc/Tag;)Landroid/nfc/tech/Ndef;
/*       */     //   43: putfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   46: aload_0
/*       */     //   47: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   50: ifnonnull +15 -> 65
/*       */     //   53: iload 5
/*       */     //   55: ifeq +7 -> 62
/*       */     //   58: aload_0
...
/*       */     //   70: ifnull +59 -> 129
/*       */     //   73: aload_0
/*       */     //   74: getfield 51	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTag	Landroid/nfc/Tag;
...
/*       */     //   129: aload_0
/*       */     //   130: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
/*       */     //   133: invokevirtual 67	android/nfc/tech/Ndef:connect	()V
/*       */     //   136: aload_0
/*       */     //   137: getfield 8	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentNdef	Landroid/nfc/tech/Ndef;
...
/*       */     //   212: putfield 44	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTagIsCardboard	Z
/*       */     //   215: iload 6
/*       */     //   217: ifne +78 -> 295
/*       */     //   220: aload_0
/*       */     //   221: getfield 44	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTagIsCardboard	Z
/*       */     //   224: ifeq +71 -> 295
/*       */     //   227: aload_0
/*       */     //   228: getfield 20	com/google/vrtoolkit/cardboard/sensors/NfcSensor:listeners	Ljava/util/List;
/*       */     //   231: dup
/*       */     //   232: astore 8
/*       */     //   234: monitorenter
/*       */     //   235: aload_0
/*       */     //   236: getfield 20	com/google/vrtoolkit/cardboard/sensors/NfcSensor:listeners	Ljava/util/List;
...
/*       */     //   294: athrow
/*       */     //   295: aload_0
/*       */     //   296: getfield 44	com/google/vrtoolkit/cardboard/sensors/NfcSensor:currentTagIsCardboard	Z
/*       */     //   299: ifeq +42 -> 341
/*       */     //   302: aload_0
/*       */     //   303: iconst_0
/*       */     //   304: putfield 7	com/google/vrtoolkit/cardboard/sensors/NfcSensor:tagConnectionFailures	I
/*       */     //   307: aload_0
/*       */     //   308: new 124	java/util/Timer
/*       */     //   311: dup
/*       */     //   312: ldc 125
/*       */     //   314: invokespecial 126	java/util/Timer:<init>	(Ljava/lang/String;)V
/*       */     //   317: putfield 127	com/google/vrtoolkit/cardboard/sensors/NfcSensor:nfcDisconnectTimer	Ljava/util/Timer;
/*       */     //   320: aload_0
/*       */     //   321: getfield 127	com/google/vrtoolkit/cardboard/sensors/NfcSensor:nfcDisconnectTimer	Ljava/util/Timer;
...
/*       */     //   205	343	346	finally
/*       */     //   346	350	346	finally } 
/*   484 */   private void closeCurrentNfcTag() { if (this.nfcDisconnectTimer != null) {
/*   485 */       this.nfcDisconnectTimer.cancel();
/*       */     }
/*       */ 
/*   488 */     if (this.currentNdef == null) {
/*   489 */       return;
/*       */     }
/*       */ 
/*       */     try
/*       */     {
/*   494 */       this.currentNdef.close();
/*       */     } catch (IOException e) {
/*   496 */       Log.w("NfcSensor", e.toString());
/*       */     }
/*       */ 
/*   499 */     this.currentTag = null;
/*   500 */     this.currentNdef = null;
/*   501 */     this.currentTagIsCardboard = false; }
/*       */ 
/*       */   private void sendDisconnectionEvent()
/*       */   {
/*   505 */     synchronized (this.listeners) {
/*   506 */       for (ListenerHelper listener : this.listeners)
/*   507 */         listener.onRemovedFromCardboard();
/*       */     }
/*       */   }
/*       */ 
...
/*   518 */       if (isCardboardNdefRecord(record)) {
/*   519 */         return true;
/*       */       }
/*       */     }
/*       */ 
...
/*       */     }
/*       */ 
/*   531 */     Uri uri = record.toUri();
/*   532 */     return (uri != null) && (CardboardDeviceParams.isCardboardUri(uri));
/*       */   }
/*       */ 
...
/*   549 */       return this.listener;
/*       */     }
/*       */ 
/*       */     public void onInsertedIntoCardboard(final CardboardDeviceParams deviceParams)
/*       */     {
/*   554 */       this.handler.post(new Runnable()
/*       */       {
/*       */         public void run() {
/*   557 */           NfcSensor.ListenerHelper.this.listener.onInsertedIntoCardboard(deviceParams);
/*       */         }
/*       */       });
/*       */     }
/*       */ 
...
/*       */     {
/*   564 */       this.handler.post(new Runnable()
/*       */       {
/*       */         public void run() {
/*   567 */           NfcSensor.ListenerHelper.this.listener.onRemovedFromCardboard();
/*       */         }
/*       */       });
/*       */     }
/*       */   }
