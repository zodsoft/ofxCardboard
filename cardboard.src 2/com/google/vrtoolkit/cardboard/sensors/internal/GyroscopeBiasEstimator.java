...
/*     */   private static final float GYRO_FOR_BIAS_THRESHOLD = 0.25F;
/*     */   private static final int IS_STATIC_NUM_FRAMES_THRESHOLD = 3;
...
/*  72 */     this.gyroBiasLowPass = new LowPassFilter(0.1500000059604645D);
/*  73 */     this.isAccelStatic = new IsStaticCounter(3);
/*  74 */     this.isGyroStatic = new IsStaticCounter(3);
/*     */   }
/*     */ 
...
/*     */ 
/* 124 */       double rampUpRatio = Math.min(1.0D, (this.gyroBiasLowPass.getNumSamples() - 30) / 100.0D);
/*     */ 
...
/*     */   {
/* 141 */     if (gyro.length() >= 0.25D)
/*     */     {
/* 144 */       return;
/*     */     }
/*     */ 
/* 147 */     double updateWeight = Math.max(0.0D, 1.0D - gyro.length() / 0.25D);
 ...
 * Qualified Name:     com.google.vrtoolkit.cardboard.sensors.internal.GyroscopeBiasEstimator
