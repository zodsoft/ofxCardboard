...
/*     */   public void setZero()
/*     */   {
/*     */     double tmp63_62 = (this.m[2] = this.m[3] = this.m[4] = this.m[5] = this.m[6] = this.m[7] = this.m[8] = 0.0D); this.m[1] = tmp63_62; this.m[0] = tmp63_62;
/*     */   }
/*     */ 
/*     */   public void setIdentity()
/*     */   {
/*     */     double tmp41_40 = (this.m[3] = this.m[5] = this.m[6] = this.m[7] = 0.0D); this.m[2] = tmp41_40; this.m[1] = tmp41_40;
/*     */     double tmp63_62 = (this.m[8] = 1.0D); this.m[4] = tmp63_62; this.m[0] = tmp63_62;
/*     */   }
/*     */ 
/*     */   public void setSameDiagonal(double d)
/*     */   {
/*     */     double tmp19_18 = (this.m[8] = d); this.m[4] = tmp19_18; this.m[0] = tmp19_18;
/*     */   }
/*     */ 
...
/*     */   {
/* 314 */     return get(0, 0) * (get(1, 1) * get(2, 2) - get(2, 1) * get(1, 2)) - get(0, 1) * (get(1, 0) * get(2, 2) - get(1, 2) * get(2, 0)) + get(0, 2) * (get(1, 0) * get(2, 1) - get(1, 1) * get(2, 0));
/*     */   }
/*     */ 
