...
/* 155 */     this.mx.setZero();
/*     */ 
/* 157 */     this.down.set(0.0D, 0.0D, 9.810000000000001D);
...
/* 300 */       float dT = (float)(sensorTimeStamp - this.sensorTimeStampGyro) * 1.0E-09F;
/* 301 */       if (dT > 0.04F)
...
/*     */     }
/*     */     else {
/* 559 */       this.filteredGyroTimestep = (0.95F * this.filteredGyroTimestep + 0.05000001F * timeStep);
/*     */ 
